"""
exp3_poison40.py
Experiment 3: FL under 40% gradient poisoning attack.
Stress test - higher poison fraction than Experiment 2.
"""
...
def main():
    print("=" * 60)
    print("Experiment 3: 40% Gradient Poisoning Attack (Stress Test)")
    ...
    out_path = os.path.join(RESULTS_DIR, "exp3_results.json")
    with open(out_path, "w") as f:
        json.dump(all_results, f, indent=2)
    print(f"\nResults saved to {out_path}")

    fig, axes = plt.subplots(1, 3, figsize=(14, 5))
    fig.suptitle("Experiment 3: 40% Gradient Poisoning Attack", fontsize=13)
    ...
    plt.tight_layout()
    plot_path = os.path.join(RESULTS_DIR, "exp3_plot.png")
